...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text">IssueWatch</span>
            </div>
            <div className="flex items-center space-x-6">
              <a href="#features" className="text-gray-600 hover:text-gray-900 transition-colors">Features</a>
              <a href="#how-it-works" className="text-gray-600 hover:text-gray-900 transition-colors">How it Works</a>
              <button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-500 transition-all hover:shadow-lg hover:shadow-blue-500/25">
      ...
      {/* Stats Section */}
      <div className="border-y border-gray-100 bg-white/50 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Repositories Tracked</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900 mb-2">1M+</div>
              <div className="text-gray-600">Issues Monitored</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="relative">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">1. Connect GitHub</h3>
              <p className="text-gray-600 leading-relaxed">
                Securely connect your GitHub account with just a few clicks.
              </p>
            </div>
            <div className="relative">
              <div className="bg-blue-50 w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
              ...
              <div className="absolute top-10 left-24 w-full md:w-32 h-0.5 bg-gradient-to-r from-blue-500 to-transparent hidden md:block" />
              <h3 className="text-xl font-semibold text-gray-900 mb-3">2. Select Repositories</h3>
              <p className="text-gray-600 leading-relaxed">
                Choose which repositories to track and set up your notification preferences.
              </p>
            </div>
            <div>
              <div className="bg-blue-50 w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
      ...
      <footer className="border-t border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <p className="text-gray-600 mt-4 md:mt-0">© 2025 IssueWatch. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
